...
class OrganizationInfoPlugin(BasePlugin):
    ...
    def metadata(self) -> PluginMetadata:
        return PluginMetadata(
            ...
            version="1.0.0",
            supported_entity_types=[TargetType.COMPANY, TargetType.PERSON, TargetType.EMAIL, TargetType.IP, TargetType.DOMAIN, TargetType.ABN, TargetType.NZ_COMPANY],
                ...
                results.append(PluginResponse(
                    ...
                    evidence=[{
                        ...
                        "technical_details": {
                            ...
                            "privacy_protection": registrar_info.get("privacy_enabled", False)
                        },
                        "business_implications": [
