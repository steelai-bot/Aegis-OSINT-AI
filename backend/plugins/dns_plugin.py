...
class DNSPlugin(BasePlugin):
    ...
    async def execute(self, query: str, target_type: TargetType) -> list[PluginResponse]:
        ...
        tasks = [self._lookup_record(client, domain, rtype, target_type) for rtype in record_types]
    ...
    async def _lookup_record(
        self, client, domain: str, rtype: str, target_type: TargetType
    ) -> PluginResponse | None:
            ...
            if resp.status_code == 200:
                ...
                if answers:
                    return PluginResponse(
                        ...
                        confidence=0.95,
                        evidence=[
                            {"record_type": rtype, "records": [a.get("data", "") for a in answers]}
                        ],
                        raw=data,
                    )
