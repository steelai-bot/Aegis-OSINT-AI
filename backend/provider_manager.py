    ...
    def __init__(self, env_path: str = ".env"):
        ...
        self.known_providers: list[dict[str, Any]] = [
            ...
            },
            {
                ...
                "description": "Multimodal AI agent (MiniMax-M3) via NVIDIA (text, images, video)",
                "supported_authentication": ["api_key"],
            },
            {
                "id": "groq",
                "name": "Groq",
                "description": "Groq AI platform (Llama, Mixtral models)",
                "supported_authentication": ["api_key"],
            },
            {
                "id": "mistral",
                "name": "Mistral",
                "description": "Mistral AI API (Mistral, Mixtral models)",
                "supported_authentication": ["api_key"],
            },
            {
                "id": "virustotal",
            ...
            },
            {
                "id": "shodan",
                "name": "Shodan",
                "description": "Search engine for IoT",
                "supported_authentication": ["api_key"],
            },
            {
                "id": "hunter",
            ...
            },
            {
                "id": "intelx",
                "name": "Intelligence X",
                "description": "Data breach and dark web search",
                "supported_authentication": ["api_key"],
            },
            {
                "id": "censys",
            ...
            },
            {
                "id": "abuseipdb",
                "name": "AbuseIPDB",
                "description": "IP abuse reporting and checking",
                "supported_authentication": ["api_key"],
            },
            {
                "id": "urlscan",
            ...
            },
            {
                ...
                "supported_authentication": ["api_key", "oauth", "none"],
            },
        ]
